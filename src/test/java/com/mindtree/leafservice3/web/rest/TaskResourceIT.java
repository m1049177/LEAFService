...
public class TaskResourceIT {
    ...
    private static final Integer DEFAULT_ESTIMATED_COST = 1;
    private static final Integer UPDATED_ESTIMATED_COST = 2;
     ...
     *
     * @see com.mindtree.leafservice3.repository.search.TaskSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getEstimatedCost()).isEqualTo(DEFAULT_ESTIMATED_COST);
        assertThat(testTask.getSuccessor()).isEqualTo(DEFAULT_SUCCESSOR);
    ...
    @Test
    @Transactional
    public void checkEstimatedCostIsRequired() throws Exception {
        int databaseSizeBeforeTest = taskRepository.findAll().size();
        // set the field null
    ...
    public void getAllTasks() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].estimatedCost").value(hasItem(DEFAULT_ESTIMATED_COST)))
    ...
    public void getTask() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks/{id}", task.getId()))
            ...
            .andExpect(jsonPath("$.estimatedCost").value(DEFAULT_ESTIMATED_COST))
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getEstimatedCost()).isEqualTo(UPDATED_ESTIMATED_COST);
        assertThat(testTask.getSuccessor()).isEqualTo(UPDATED_SUCCESSOR);
