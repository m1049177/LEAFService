...
public class LabelResourceIT {
    ...
    private static final String DEFAULT_LABEL_DATA = "AAAAAAAAAA";
    private static final String UPDATED_LABEL_DATA = "BBBBBBBBBB";
     ...
     *
     * @see com.mindtree.leafservice3.repository.search.LabelSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createLabel() throws Exception {
        ...
        assertThat(testLabel.getLabel_data()).isEqualTo(DEFAULT_LABEL_DATA);
    ...
    @Test
    @Transactional
    public void checkLabel_typeIsRequired() throws Exception {
        int databaseSizeBeforeTest = labelRepository.findAll().size();
        // set the field null
        label.setLabel_type(null);
    ...
    public void getAllLabels() throws Exception {
        ...
        restLabelMockMvc.perform(get("/api/labels?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].label_type").value(hasItem(DEFAULT_LABEL_TYPE)))
            .andExpect(jsonPath("$.[*].label_data").value(hasItem(DEFAULT_LABEL_DATA.toString())));
    }
    ...
    public void getLabel() throws Exception {
        ...
        restLabelMockMvc.perform(get("/api/labels/{id}", label.getId()))
            ...
            .andExpect(jsonPath("$.label_type").value(DEFAULT_LABEL_TYPE))
            .andExpect(jsonPath("$.label_data").value(DEFAULT_LABEL_DATA.toString()));
    }
    ...
    public void updateLabel() throws Exception {
        ...
        assertThat(testLabel.getLabel_data()).isEqualTo(UPDATED_LABEL_DATA);
